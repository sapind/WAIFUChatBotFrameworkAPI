...
public class PUTCreateUser extends BaseTest{
	 ...
	 Response response;
		  ...
		  String text=RestApiUtils.text(); String
		  firstUser=RestApiUtils.firstUser(); String
		  secondUser=RestApiUtils.secondUser(); String
		  situation=RestApiUtils.situation();
		 
	
	 @BeforeClass
		public void putCreateUser() throws InterruptedException
		{
			...
			requestParams.put("translate_to","auto");
			 ...
			 .header("X-RapidAPI-Key","ece75f7538msha5d1535561fa866p122932jsn35d5efd02f6a")
				...
				//PostRequest
				 response= httpRequest.request(Method.PUT,"user/id/"+userID);
