...
public class GETExistUser extends BaseTest {
	
	 @BeforeClass
		public void getExistUser() throws InterruptedException
		{
			logger.info("*************GetExistUser**************");
			...
			response=httpRequest.request(Method.GET,"/user/id/"+userID);
